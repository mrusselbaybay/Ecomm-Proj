 ...
 * products.images / product_variants.image / reviews.images: a real
 * file goes here instead, and only a short {path, url} reference gets
 * stored in the database row. That's what fixed the seller product list
 * timing out (SELECT * was pulling megabytes of base64 text through the
 * DB connection on every load — see the incident this class was built
 * to resolve).
 */
