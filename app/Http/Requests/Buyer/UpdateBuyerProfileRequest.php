...
/**
 * Self-service "My Account" edit for a buyer: name/sex/birthday/contact
 * fields on public.profiles, plus their single on-file address (owner_kind
 * = 'profile') — province/municipality/barangay are populated from the
 * PSGC dropdowns in Account.vue, the same lookup used by the seller/
 * courier/logistics registration wizards (see PsgcProxyController).
 *
 * Email is intentionally absent — never editable here, same as
