...
## Corpus Check
- 734 files · ~754,065 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 85 file(s) not represented in the graph (top: .csv 53, (none) 18, .css 10)

## Summary
- 8546 nodes · 15491 edges · 443 communities (312 shown, 131 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 457 edges (avg confidence: 0.85)
...
1. `Profile` - 178 edges
2. `Controller` - 115 edges
3. `Order` - 114 edges
4. `vue` - 108 edges
5. `LogisticsCompany` - 99 edges
6. `ParcelAssignment` - 92 edges
7. `Conversation` - 83 edges
8. `Product` - 70 edges
9. `CourierApplication` - 60 edges
...
## Communities (443 total, 131 thin omitted)
...
### Community 1 - "Order"
Cohesion: 0.04
Nodes (15): AutoDeliverStaleOrders, BackfillOrderShippingArea, CopyPgsqlToMysql, DeleteDummyCouriers, SimulateParcelTracking, SellerOrderController, Order, OrderStatusHistory (+7 more)
...
### Community 7 - "Profile"
Cohesion: 0.04
Nodes (28): AccountRegistrationController, ComplaintController, UserAccountController, CourierDetail, OrderItem, Profile, SellerDetail, Illuminate\Database\Eloquent\Relations\HasMany (+20 more)
...
Cohesion: 0.05
Nodes (22): DashboardController, Controller, AccountStatusChanged, Address, Document, BelongsTo, BelongsTo, StatusAuditLog (+14 more)

### Community 10 - "ParcelAssignment"
Cohesion: 0.05
Nodes (14): ParcelAssignmentController, DriverDeliveryController, AssignParcelRequest, AssignTransferRequest, ReceiveParcelRequest, LogisticsCompanyResource, LogisticsApplicationResource, ParcelAssignmentResource (+6 more)

### Community 11 - "Delivery.vue"
Cohesion: 0.09
...
Cohesion: 0.04
Nodes (17): RejectRegistrationRequest, DeactivateBuyerAccountRequest, SendMessageRequest, StartConversationRequest, StartCourierConversationRequest, UpdatePaymentMethodRequest, UpdateProfileRequest, UpdateDriverProfileRequest (+9 more)
...
### Community 14 - "ResignationRequest"
Cohesion: 0.17
...
### Community 17 - "vue"
Cohesion: 0.09
Nodes (18): *.vue, vue, resources_css_buyer_layout, app, confirmBtnRef, { confirmState, accept, cancel }, dialogRef, clamp() (+10 more)
...
Cohesion: 0.07
Nodes (26): addressError, barangays, busy, confirmMismatch, error, { fetchProvinces, fetchMunicipalities, fetchBarangays }, Field, fieldErrors (+18 more)
...
Cohesion: 0.13
Nodes (12): AuthenticateSupabaseUser, EnsureUserIsAdmin, EnsureUserIsBuyer, EnsureUserIsDriver, EnsureUserIsLogistics, EnsureUserIsSeller, Closure, Illuminate\Foundation\Application (+4 more)
...
Cohesion: 0.06
Nodes (13): AccountController, LogisticsAccountController, ParcelInventoryController, OrderController, ReviewController, WishlistController, ParcelLocationController, PickupCourierController (+5 more)
...
Cohesion: 0.06
Nodes (10): CourierApplicationController, CourierProfileController, LogisticsApplicationController, Closure, AccountController, CatalogController, PsgcProxyController, UploadMessageAttachmentRequest (+2 more)
...
Cohesion: 0.03
Nodes (29): BuyerAddress, BuyerPaymentMethod, Complaint, ComplaintUpdate, HasUuidPrimaryKey, Conversation, DriverDetail, LogisticsProvincialAssignment (+21 more)
...
### Community 40 - "InventoryService"
Cohesion: 0.13
Nodes (4): SellerInventoryController, AdjustStockRequest, InventoryMovement, InventoryService
...
Cohesion: 0.05
Nodes (12): LogisticsRegionalAssignmentController, ScopesLogisticsCompany, SellerCourierController, LogisticsCompany, ParcelAutoAssignService, ParcelIntakeService, ServiceAreaProvisioner, TransferTriggerService (+4 more)
...
Cohesion: 0.06
Nodes (19): User, ConversationParticipantFactory, LogisticsBarangayAssignmentFactory, ParcelAssignmentFactory, SupportTicketFactory, SupportTicketInternalNoteFactory, UserFactory, Illuminate\Database\Eloquent\Attributes\Fillable (+11 more)
...
Cohesion: 0.09
Nodes (14): AccountCreated, ApplicationInterview, ApplicationRejected, ApplicationTerminated, InvitationRenewalRequested, TeamInvitation, PasswordResetCodeMail, PasswordResetMail (+6 more)
...
### Community 96 - "SellerReportController"
Cohesion: 0.15
Nodes (7): SellerReportController, SellerReportService, Carbon\Carbon, Carbon\CarbonImmutable, Carbon\Constants\UnitValue, Illuminate\Http\Response, Illuminate\Support\Facades\Validator
...
### Community 98 - "Illuminate\Support\Facades\Schema"
Cohesion: 0.01
Nodes (5): Illuminate\Database\Migrations\Migration, Illuminate\Database\Query\Expression, Illuminate\Database\Schema\Blueprint, Illuminate\Http\UploadedFile, Illuminate\Support\Facades\Schema
...
### Community 114 - "Seller/MessageController.php"
Cohesion: 0.05
Nodes (18): PruneStagedMessageAttachments, MessageAttachmentController, ConversationParticipant, MessageAttachment, ConversationPolicy, DeliveryConversationService, DirectConversationService, MessageAttachmentService (+10 more)

### Community 115 - "useReports"
Cohesion: 0.25
...
### Community 132 - "ProductVariant"
Cohesion: 0.18
Nodes (3): ProductVariant, CheckoutService, Illuminate\Support\Collection
...
Cohesion: 0.14
Nodes (17): onAvatarCropped(), address, age, avatarUrl, company, fullName, initials, loadProfileData() (+9 more)
...
### Community 201 - "Configuration Best Practices"
Cohesion: 0.33
...
Cohesion: 0.15
Nodes (4): AddressController, CheckoutController, ReturnController, CheckoutRequest

### Community 215 - "AppServiceProvider"
Cohesion: 0.24
...
### Community 226 - "Illuminate\Database\Eloquent\Builder"
Cohesion: 0.16
Nodes (4): LogisticsCompanyController, MessageController, Illuminate\Database\Eloquent\Builder, Illuminate\Http\Resources\Json\AnonymousResourceCollection
...
### Community 240 - "useBuyerSession.js"
Cohesion: 0.19
...
### Community 263 - "laravel-best-practices/SKILL.md"
Cohesion: 0.14
Nodes (11): Keep Controllers Thin, Routing & Controllers Best Practices, Type-Hint Form Requests, Use Implicit Route Model Binding, Use Resource Controllers, Use Scoped Bindings for Nested Resources, Consistency First, Decision Rules (+3 more)
...
### Community 275 - "detect_domain"
Cohesion: 0.23
Nodes (3): detect_domain(), Auto-detect the most relevant domain from query. Matches are weighted by…, TestDomainDetection

### Community 277 - "openConversation"
Cohesion: 0.26
...
Cohesion: 0.05
Nodes (11): UpdateAccountStatusRequest, StoreAddressRequest, StorePaymentMethodRequest, UpdateAddressRequest, UpdateConversationStatusRequest, UpdateConversationStatusRequest, UpdateConversationStatusRequest, ReportReviewRequest (+3 more)

### Community 322 - "Events & Notifications Best Practices"
Cohesion: 0.22
