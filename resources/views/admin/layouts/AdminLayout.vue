...
<template>
    <div class="flex min-h-screen" style="height: 100vh; overflow: hidden">
        <!-- SIDEBAR -->
        <aside
            class="side-panel flex w-64 flex-shrink-0 flex-col justify-between px-4 py-6 text-white"
            style="height: 100vh; overflow-y: auto"
        >
            <div>
                <div class="mb-8 flex items-center gap-3 px-2">
                    <div
                        class="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-orange-500 to-amber-500"
                    >
                        <svg
                            width="18"
                            height="18"
                    ...
                    <div>
                        <p
                            class="text-sm leading-tight font-bold tracking-wide"
                        >
                            NEXMART
                        </p>
                        <p
                            class="text-[0.65rem] leading-tight font-bold tracking-widest text-orange-400 uppercase"
                        >
                            Admin Panel
                        </p>
                    </div>
                ...
                <nav class="space-y-1">
                    ...
                    >
                        ...
                        <span
                            v-if="item.badge"
                            class="badge badge-amber ml-auto text-xs"
                            >{{ item.badge }}</span
                        >
                    </div>
                </nav>
            ...
            <div>
                <div class="mb-2 border-t border-white/10 pt-3">
                ...
                <div class="flex items-center gap-2 px-2">
                    <div
                        class="flex h-8 w-8 items-center justify-center rounded-full bg-orange-500/20 text-xs font-bold text-orange-400"
                    >
                        {{ adminInitials }}
                    </div>
        ...
        <main class="flex-1 overflow-y-auto" style="height: 100vh">
            <div class="mx-auto max-w-6xl px-8 py-8">
                <div class="mb-6 flex items-center justify-between">
                    <div>
                        <p
                            class="mb-1 text-xs font-bold tracking-widest text-orange-500 uppercase"
                        >
                            Admin Panel
                        </p>
                        <h1 class="section-title text-3xl text-slate-900">
                            {{ $route.meta.title || 'Dashboard' }}
                        </h1>
                    </div>
                    <div class="flex items-center gap-2">
                        <span v-if="pendingCount > 0" class="badge badge-amber"
