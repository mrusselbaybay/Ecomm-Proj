...
<template>
    <div>
        <p class="mb-4 text-sm text-slate-500">
            View user profiles and activate, suspend, or deactivate accounts.
        </p>
                ...
                <tbody>
                    ...
                    <tr v-for="(user, idx) in users" :key="idx">
                        ...
                        <td>
                            <span
                                class="status-dot"
                                :class="user.account_status || user.status"
                            ></span>
                            <span
                                class="badge"
                                :class="
                                ...
                                "
                                >{{ user.account_status || user.status }}</span
                            >
                        </td>
                        <td>
                            <div class="flex gap-2">
                                ...
                                <button
                                    @click="updateStatus(user, 'deactivated')"
...
const { users, loading, loadUsers, updateUserStatus, statusBadgeClass } =
    useAdmin();
