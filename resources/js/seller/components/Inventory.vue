    ...
    <div class="inventory-page">
            ...
            <div class="toolbar-left">
                ...
                <div class="toolbar-buttons">
                    ...
                    >
                        ...
                        >
                            <path
                                d="M4 6h12M8 6V4h4v2M6 6l.7 9a1 1 0 0 0 1 1h4.6a1 1 0 0 0 1-1L14 6"
                            />
                        </svg>
                        Delete Selected
                    </button>
                    ...
                    >
                        ...
                        >
                            <path
                                d="M3 6a1 1 0 0 1 1-1h4l1.5 2H16a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6Z"
                            />
                        </svg>
                        Move Category
                    </button>
        ...
        <div class="inventory-layout">
            <aside class="inventory-filters">
                <div class="filter-group">
                    ...
                    <div v-if="categories.length === 0" class="filter-empty">
                        No categories yet.
                    </div>
                    <label
                        ...
                        <p>
                            {{
                                isNewProduct
                                    ...
                                    : 'Edit product details & availability'
                            }}
                        </p>
                    </div>
        ...
        >
            <div class="modal-panel">
                ...
                <p class="modal-desc">
                    This can't be undone. The listing{{
                        deleteTarget === 'bulk' ? 's' : ''
                    }}
        ...
        >
            <div class="modal-panel">
                ...
                <input
                    type="text"
                    class="field-input"
                    v-model="moveCategoryInput"
                    list="category-options"
                    placeholder="e.g. Accessories > Photography"
                />
                <div class="modal-actions">
                    <button
                        class="btn-outline"
                    ...
                    <button
                        class="btn-primary"
                        style="flex: 1"
                        :disabled="!moveCategoryInput.trim()"
                        @click="confirmMove"
                    >
                        Move
                    </button>
