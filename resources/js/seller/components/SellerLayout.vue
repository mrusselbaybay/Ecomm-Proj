    ...
    <div class="seller-app">
        ...
        >
            ...
            <main class="seller-main">
                <div class="seller-content-wrapper" :class="{ 'is-messages-page': currentSection === 'messages' }">
                    <!-- Hidden on Account Settings (has its own header, see
                         Profile.vue) and on Messages (the chat panels need the
                         full page height, and this header's search/notif/
                         profile bar just duplicates the sidebar). -->
                    <div v-if="currentSection !== 'account' && currentSection !== 'messages'" class="content-header">
                        <div>
