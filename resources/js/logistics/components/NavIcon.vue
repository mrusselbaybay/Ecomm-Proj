...
const ICONS = {
    ...
    support: [
        'M12 20.4a8.4 8.4 0 1 0 0-16.8 8.4 8.4 0 0 0 0 16.8Z',
        'M9.4 9.4a2.6 2.6 0 1 1 3.6 2.4c-.7.4-1 .9-1 1.7v.3',
        'M12 16.6h.01',
    ],
    scan: [
    ...
    store: [
        'M4 9.5 5.2 4h13.6L20 9.5',
        'M4 9.5a2 2 0 0 0 4 0 2 2 0 0 0 4 0 2 2 0 0 0 4 0 2 2 0 0 0 4 0',
        'M5 9.5V20h14V9.5',
        'M9.5 20v-6h5v6',
    ],
    team: [
        'M16 19v-1.5a3.5 3.5 0 0 0-3.5-3.5h-5A3.5 3.5 0 0 0 4 17.5V19',
        'M10 10.5a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z',
        'M20 19v-1.5a3.5 3.5 0 0 0-2.5-3.35M15.5 4.6a3 3 0 0 1 0 5.8',
    ],
    mail: [
