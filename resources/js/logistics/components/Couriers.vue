        ...
        <div class="page-header">
            <div>
                ...
                <p class="page-subtitle">
                    Couriers currently affiliated with {{ companyName }}.
                </p>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr v-else-if="couriers.length === 0">
                        <td colspan="4" class="empty-state">
                            <p>
                                No couriers yet — accepted applications will
                                appear here.
                            </p>
                        </td>
                    </tr>
...
async function removeCourier(c) {
    if (
        !confirm(`Remove ${c.profile?.first_name} from ${companyName.value}?`)
    ) {
        return;
    }
    ...
    try {
        ...
        await supabase
            ...
            .update({
                status: 'rejected',
                rejection_reason: 'Removed from company by company staff',
            })
