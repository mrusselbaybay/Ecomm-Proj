...
async function logout() {
  try {
    ...
    // The login page reads this cookie to auto-redirect signed-in visitors
    // back to their dashboard. Leaving it behind after sign-out sent
    // couriers straight back to /pickup-courier with no real session,
    // which showed "Access Denied" before they could reach the login form.
    document.cookie =
