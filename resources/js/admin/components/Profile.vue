  ...
  <div class="card p-5 max-w-lg">
    ...
    <div class="space-y-3 mb-4">
      <div>
        ...
        <input class="field-input" v-model="adminProfile.name" />
      </div>
      <div>
        <label class="field-label">Email</label>
        <input class="field-input" v-model="adminProfile.email" disabled />
      </div>
      <div>
        <label class="field-label">Role</label>
        <input class="field-input" v-model="adminProfile.role" disabled />
      </div>
    </div>
