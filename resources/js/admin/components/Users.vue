    ...
    <div class="admin-users-wrap">
        ...
        <div class="page-header">
            <div>
                ...
                <p class="page-subtitle">
                    Review applications, manage account access, and create staff
                    accounts.
                </p>
            </div>
        ...
        <div class="mb-6 grid grid-cols-5 gap-4">
            <div class="stat-card">
                ...
                <p class="stat-total text-2xl font-bold">{{ totalUsers }}</p>
            </div>
            <div class="stat-card">
            ...
            <div class="stat-card">
                ...
                <p class="stat-active text-2xl font-bold">{{ activeCount }}</p>
            </div>
            <div class="stat-card">
                <p class="field-label">Suspended</p>
                <p class="stat-suspended text-2xl font-bold">
                    {{ suspendedCount }}
                </p>
            </div>
            <div class="stat-card">
                ...
                <tbody>
                    ...
                    <tr v-for="user in paginatedUsers" :key="user.id">
                        ...
                        <td>
                            <span
                                class="badge"
                                :class="approvalBadgeClass(user.status)"
                            >
                                <span
                                    class="status-dot"
                                    :class="user.status"
                        ...
                        <td>
                            ...
                            >
                                <span
                                    class="status-dot"
                                    :class="user.account_status || 'pending'"
                                ></span
                                >{{ user.account_status || 'pending' }}
                            </span>
                        </td>
                        <td>
                            ...
                            >
                                ...
                                >
                                    <path
                                        d="M6 2.5h6l3 3v11a1 1 0 01-1 1H6a1 1 0 01-1-1v-13a1 1 0 011-1z"
                                        stroke="currentColor"
                                        stroke-width="1.4"
                                        stroke-linejoin="round"
                                    />
                                    <path
                                        d="M8 10h5M8 13h5M12 2.5V6h3.5"
                                        stroke="currentColor"
                                        stroke-width="1.4"
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                ...
                                <template v-if="user.status === 'rejected'">
                                    <div class="flex">
                                        ...
                                        >
                                            ...
                                            >
                                                <path
                                                    d="M8 3.5a4.5 4.5 0 00-4.5 4.5c0 2.5 4.5 6.5 4.5 6.5s4.5-4 4.5-6.5A4.5 4.5 0 008 3.5z"
                                                    stroke="currentColor"
                                                    stroke-width="1.4"
                                                />
                                                <circle
            ...
            >
                <div class="modal-panel modal-lg">
                    ...
                    <p class="modal-desc">
                        ...
                        <strong>{{ displayName(rejectUserData) }}</strong
                        >'s application:
                    </p>
            ...
            >
                <div class="modal-panel modal-sm">
                    ...
                    <p class="modal-desc">
                        ...
                        <strong>{{ displayName(reasonUser) }}</strong
                        >:
                    </p>
            ...
            >
                <div class="modal-panel modal-lg">
                    ...
                    <p class="modal-desc">
                        ...
                        <strong>{{ displayName(statusChangeUser) }}</strong
                        >'s account:
                    </p>
                    ...
                    <div class="space-y-3">
                        ...
                        <div
                            v-for="reason in statusChangeAction === 'suspended'
                                ? suspensionReasons
                                : deactivationReasons"
                            :key="reason.value"
                            class="reason-option"
                            :class="{
                                active: selectedStatusReason === reason.value,
                            }"
                        ...
                        <div
                            class="reason-option"
                            :class="{
                                active: selectedStatusReason === 'others',
                            }"
                            @click="selectedStatusReason = 'others'"
                        >
                            <input
                                type="radio"
                                value="others"
                ...
                <div class="modal-panel modal-lg">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="modal-subtitle">
                                    Add a new platform admin or logistics admin
                                </p>
                            </div>
                        </div>
                        <button
                    ...
                    <div class="role-picker">
                        ...
                        >
                            ...
                            <div class="role-card-icon">
                                ...
                                >
                                    <path
                                        d="M10 2l6 3v4.5c0 4-2.6 6.8-6 8-3.4-1.2-6-4-6-8V5l6-3z"
                                        stroke="currentColor"
                                        stroke-width="1.5"
                                        stroke-linejoin="round"
                                    />
                            ...
                            <p class="role-card-desc">
                                Full access to manage users, approvals, and
                                platform settings.
                            </p>
                        </button>
                        ...
                        <button
                            ...
                            class="role-card"
                            :class="{
                                active: newStaff.role === 'logistics_admin',
                            }"
                            @click="newStaff.role = 'logistics_admin'"
                        >
                            <span
                                class="role-card-check"
                                v-if="newStaff.role === 'logistics_admin'"
                            >
                                <svg
                                    class="icon-xs"
                                    viewBox="0 0 20 20"
                            ...
                            <p class="role-card-desc">
                                Manages drivers and orders for a logistics
                                company.
                            </p>
                        </button>
                    </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div>
                            ...
                            <input
                                v-model="newStaff.middle_initial"
                                type="text"
                                maxlength="1"
                                class="field-input"
                                placeholder="B"
                                @input="capitalizeMiddleInitial"
                            />
                        </div>
                        <div class="full-span">
                        ...
                        <div class="full-span">
                            ...
                            <div class="password-row">
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            d="M4 10a6 6 0 0110.9-3.4M16 10a6 6 0 01-10.9 3.4"
                                            stroke="currentColor"
                                            stroke-width="1.5"
                                            stroke-linecap="round"
                                        />
                                        <path
                                            d="M14.5 3.5v3.5H11M5.5 16.5V13H9"
                                            stroke="currentColor"
                                            stroke-width="1.5"
                                            stroke-linecap="round"
                                            stroke-linejoin="round"
                    ...
                    <div class="info-banner">
                        ...
                        <p>
                            This account is created and email-verified
                            immediately — no manual approval needed. Login
                            credentials are emailed to them automatically.
                        </p>
                    </div>
                    ...
                    <div v-else class="doc-list">
                        ...
                        >
                            ...
                            <div class="doc-actions">
                                <span
                                    class="badge"
                                    :class="approvalBadgeClass(doc.status)"
                                    >{{ doc.status }}</span
                                >
                                <button
            ...
            >
                <div class="modal-panel modal-sm">
                    <div class="confirm-icon" :class="confirmModal.variant">
                        <svg
                            v-if="confirmModal.variant === 'danger'"
                            class="icon-lg"
                            viewBox="0 0 24 24"
                            fill="none"
                        >
...
const { accounts, pendingCount, supabase, supabaseAdmin } = useAdmin();
...
const totalPages = computed(() =>
    Math.ceil(accounts.value.length / pageSize.value),
);
...
const suspensionReasons = [
    {
        ...
        description:
            'The user has been involved in chargebacks or fraudulent payment activities.',
    },
    {
        value: 'prohibited_products',
        label: 'Selling prohibited or counterfeit products',
        description:
            'The user is selling items that violate platform policies or are counterfeit.',
    },
    {
        value: 'failed_payments',
        label: 'Too many failed or suspicious payment attempts',
        description:
            'Multiple failed or suspicious payment attempts have been detected.',
    },
    {
        value: 'abusive_behavior',
        label: 'Abusive, threatening, or inappropriate behavior',
        description:
            'The user has engaged in abusive, threatening, or inappropriate behavior.',
    },
];
...
const deactivationReasons = [
    {
        ...
        description:
            'The user has been suspended multiple times or committed serious violations.',
    },
    {
        value: 'security_concerns',
        label: 'Account security concerns',
        description:
            'The account poses security risks to the platform or other users.',
    },
];
...
async function submitCreateStaff() {
    ...
    if (!newStaff.password || newStaff.password.length < 8) {
        showToast(
            'Password must be at least 8 characters. Use the generate button if needed.',
            'error',
        );
    ...
    try {
        ...
        showToast(
            `${formatRole(newStaff.role)} account created for ${newStaff.email}.`,
            'success',
        );
        resetNewStaff();
        await loadData();
...
const activeCount = computed(
    () => accounts.value.filter((u) => u.account_status === 'active').length,
);
const suspendedCount = computed(
    () => accounts.value.filter((u) => u.account_status === 'suspended').length,
);
const deactivatedCount = computed(
    () =>
        accounts.value.filter((u) => u.account_status === 'deactivated').length,
);
...
async function loadData() {
    ...
    try {
        ...
        pendingCount.value = accounts.value.filter(
            (u) => u.status === 'pending',
        ).length;
...
async function approveUser(user) {
    const ok = await askConfirm(
        'Approve application',
        `Approve ${displayName(user)}? They will be able to log in immediately.`,
...
async function reapproveUser(user) {
    const ok = await askConfirm(
        ...
        `Re-approve ${displayName(user)}? This will allow them to log in again.`,
...
async function submitStatusChange() {
    ...
    try {
        ...
        showToast(
            `${displayName(userData)} has been ${labels[status]}d.`,
            'success',
        );
        await loadData();
    } catch (error) {
